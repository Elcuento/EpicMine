...
public class EditorExploderObject : UnityEditor.Editor
{
    ...
    SerializedProperty fragmentMaterials;
    ...
    private void OnEnable()
    {
        ...
        //fragmentMaterials = serializedObject.FindProperty("FragmentOptions.FragmentMaterial");
...
//            EditorGUILayout.Space();
         ...
         //   change |= EditorExploderUtils.ObjectSelection<Material>("Materials", "Optional material for fragments.",
          //      fragmentMaterials);
