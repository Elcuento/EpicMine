...
namespace Exploder
{
    ...
    public class Fragment : MonoBehaviour
    {
        ...
        /// </summary>
        [NonSerialized]
        public CrackedObject CrackedOwner;
        ...
        /// <summary>
        /// reset to original crackobject state
        /// </summary>
        public void ResetOriginal()
        {
            ...
            rigId.useGravity = storedGravirty;
            rigId.velocity = storedVelocity;
            rigId.mass = storedMass;
        }

        public void DetachCrackedObject()
        {
            Cracked = false;
            CrackedOwner = null;
        }
