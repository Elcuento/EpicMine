...
namespace Exploder
{
    class Core : Singleton<Core>
    {
        ...
        public void RemoveCrackedObject(GameObject obj)
        {
            crackManager.RemoveCrackedObject(obj);
        }
        public CrackedObject GetCrackedObject(GameObject obj)
        {
            return crackManager.GetCrackedObject(obj);
        }
