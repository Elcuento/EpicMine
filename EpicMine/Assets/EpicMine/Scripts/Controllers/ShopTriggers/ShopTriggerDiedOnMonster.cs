...
public class ShopTriggerDiedOnMonster : ShopTrigger
{
    public int RequiredDieInRow;
    public int Died;

    public ShopTriggerDiedOnMonster(int die, string offerId, bool isCompleted = false) : base(offerId, isCompleted)
    {
    ...
    {
        var monsterWall = data.Section as MineSceneMonsterSection;
    ...
    public void OnPickaxeDestroy(MineScenePickaxeDestroyedEvent destroy)
    {
        ...
        {
            var monsterWall = destroy.Section as MineSceneMonsterSection;
