...
{
    public class ResponseChestOpen : Response<RequestDataChestOpen>
    {

        public ResponseChestOpen(ClientPeer peer, Package pack) : base(peer, pack)
        {
        }
        ...
        protected override bool OnProcess()
        {
            lock (Peer.Player)
            {
                ...
                {
                    LogError("Chest data not exist");
                    return false;
                }

                return OpenChestInternal(staticData.Configs, chestType, chestData);
            }
        }


        bool OpenChestInternal(Configs data, ChestType type, Chest chest = null)
        {
            ...
            ResponseData = new ResponseDataChestOpen(randomDroppedArtefactsAmount, randomDroppedCrystalsAmount);
