...
namespace Exploder
{
    ...
    public class ExploderObject : MonoBehaviour
    {
        ...
        {
            var materials = obj.GetComponentInChildren<MeshRenderer>().materials;
            FragmentOptions.FragmentMaterials = materials;
            ExplodeObject(obj, null);
          
        }
        public void ExplodeObject(GameObject obj, bool selftexture)
        {
            var materials = obj.GetComponentInChildren<MeshRenderer>().materials;
            FragmentOptions.FragmentMaterials = materials;
            ExplodeObject(obj, null);
