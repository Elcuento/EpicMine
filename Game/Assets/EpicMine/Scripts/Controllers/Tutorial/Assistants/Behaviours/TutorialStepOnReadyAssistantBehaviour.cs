...
{
    public class TutorialStepOnReadyAssistantBehaviour : TutorialStepAssistantBehaviour
    {
        [Space]
        ...
        private void OnStepReady(TutorialStepReadyEvent eventData)
        {
        ...
        {
            EventManager.Instance.Subscribe<TutorialStepReadyEvent>(OnStepReady);
        }

        private void Unsubscribe()
        {
            if (EventManager.Instance != null)
                EventManager.Instance.Unsubscribe<TutorialStepReadyEvent>(OnStepReady);
        }
    }
}